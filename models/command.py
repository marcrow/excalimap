...
class Command(MapObject):
    ...
    def draw(self, x, y):
        ...
        calc_height = max(Config.command_height, num_lines * line_height + 10)  # +10 for padding
        ...
        title_y = center_y - calc_height / 2
        ...
        if os.path.isfile(file_path):
            ...
            image_y_pos = title_y + (calc_height-Config.image_height)/2
